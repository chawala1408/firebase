...
# กำหนดเส้นทางไปยังไฟล์ credential ที่ได้จาก Firebase Console
cred = credentials.Certificate("D:/test_แยก/check-4c4c4-firebase-adminsdk-19nma-26cad9b529.json")
...
result_pass_ref = db.reference('/Pass/MAC ID')
result_pass = result_pass_ref.get()

result_ng_ref = db.reference('/NG/MAC ID')
result_ng = result_ng_ref.get()
                    ...
                    if st.button("💾 **บันทึกการเปลี่ยนแปลง**"):
                        try:
                            ...
                            if mac_path:
                                ...
                                db.reference(mac_path).update({"Localtion": new_location})
